...
CAMERA_URL = "https://Leo:Xonae$2410@10.13.45.103/axis-cgi/mjpg/video.cgi"
...
def gen_frames():
    ...
    #define os tempos (30 desde que o trator nao deteta depois de detetar, 6 minimo de trator presente no ecrã)
...
#redimensiona video
        view_frame = cv2.resize(annotated_frame, (800, 450))
