...
MODELO = r"C:\Users\frrodrigues.INDPT\Desktop\projeto_defeitos_manta\passo_2_teste_modelo\modelo_defeitos_manta_v1.pt"

PASTA_IMAGENS = r"C:\Users\frrodrigues.INDPT\Pictures\A"

PASTA_SAIDA = r"C:\Users\frrodrigues.INDPT\Desktop\projeto_defeitos_manta\passo_2_teste_modelo\resultados_defeitos"
...
for i, imagem_path in enumerate(imagens):
    ...
    try:
        ...
        # -----------------------------
        # Guardar imagem anotada YOLO
        # -----------------------------
        annotated_img = result.plot()

        caminho_anotado = os.path.join(
            PASTA_SAIDA,
            f"{nome}_anotado.png"
        )
